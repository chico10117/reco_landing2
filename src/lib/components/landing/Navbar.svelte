      ...
      <div class="flex items-center space-x-24">
        ...
        <div class="hidden lg:flex lg:items-center">
          <div class="flex items-center space-x-12">
            ...
            <a href="https://calendar.app.google/C3yhn8ZD1ZcMSCPC7" target="_blank" rel="noopener noreferrer" class="inline-block ml-28" onclick={closeAllMenus}>
              <Button 
                variant="default" 
      ...
      <div class="py-4 px-4 bg-white shadow-lg">
        <div class="flex flex-col space-y-2">
          ...
          <div class="pt-2 border-t border-gray-200">
            <a href="https://calendar.app.google/C3yhn8ZD1ZcMSCPC7" target="_blank" rel="noopener noreferrer" class="inline-block pt-2" onclick={closeAllMenus}>
              <Button 
                variant="default" 
