...
export const translations = {
	es: {
		...
		independiente_hero_subtitle: 'Reco es el camarero digital que apoya a tu equipo.',
		independiente_info: 'Reco traduce, recomienda y promociona tu carta sin tener que imprimir nada ni capacitar a todo el personal.',
		independiente_problem_title: 'El problema',
		independiente_problem_desc_1: 'Personal cambiante. Turistas que no entienden la carta. Platos que quieres promocionar.',
		independiente_problem_desc_2: 'Reco es la ayuda invisible que alivia tu trabajo.',
		independiente_solution_title: '¿Qué hace Reco?',
		independiente_feature_translate: 'Traduce automáticamente tu carta.',
		independiente_feature_highlight: 'Destaca los platos que quieres impulsar.',
		independiente_feature_answer: 'Responde las preguntas frecuentes de los clientes.',
		independiente_feature_help_staff: 'Ayuda al personal nuevo a vender como un experto.',
		independiente_feature_analytics: 'Te muestra qué platos funcionan mejor.',
		independiente_benefits_title: 'Beneficios concretos',
		independiente_benefit_menu_time: 'Ahorra tiempo en actualizaciones de carta.',
		independiente_benefit_order_errors: 'Previene errores en los pedidos.',
		independiente_benefit_tourist_experience: 'Mejora la experiencia de los turistas.',
		independiente_benefit_staff_confidence: 'Da confianza a tu equipo.',
		independiente_benefit_menu_decisions: 'Te ayuda a tomar decisiones sobre la carta.',
		independiente_benefit_no_installation: 'No requiere instalación.',
		independiente_howto_title: '¿Cómo funciona?',
		independiente_step_upload: 'Subes tu carta a Reco.',
		independiente_step_access: 'Tus clientes acceden vía QR.',
		independiente_step_show: 'Reco muestra tus platos destacados y responde preguntas.',
		independiente_step_control: 'Tú controlas qué destacar cada día.',
		independiente_cta_title: 'Haz que tus clientes disfruten más.',
		independiente_cta_description: 'Haz que tu equipo trabaje mejor.',
		independiente_cta_demo: 'Solicita una demo para restaurantes independientes',
		independiente_cta_cases: 'Ve cómo Reco ayuda a restaurantes como el tuyo',
		
		// MULTINACIONAL RESTAURANT PAGE
		multinacional_hero_title_1: 'Consistencia global, experiencia local.',
		multinacional_hero_title_2: 'Reco se adapta a cada mercado.',
		multinacional_hero_subtitle: 'Reco es el camarero digital que apoya a tu equipo.',
		multinacional_info: 'Reco traduce, recomienda y promociona tu carta sin tener que imprimir nada ni capacitar a todo el personal.',
		multinacional_problem_title: 'El problema',
		multinacional_problem_desc_1: 'Operaciones en múltiples países, equipos rotativos, clientes de todo el mundo.',
		multinacional_problem_desc_2: 'Reco es la ayuda invisible que mantiene la experiencia consistente y local.',
		multinacional_solution_title: '¿Qué hace Reco?',
		multinacional_feature_translate: 'Traduce automáticamente tu carta.',
		multinacional_feature_highlight: 'Destaca los platos que quieres impulsar.',
		multinacional_feature_answer: 'Responde las preguntas frecuentes de los clientes.',
		multinacional_feature_help_staff: 'Ayuda al personal nuevo a vender como un experto.',
		multinacional_feature_analytics: 'Te muestra qué platos funcionan mejor.',
		multinacional_benefits_title: 'Beneficios concretos',
		multinacional_benefit_menu_time: 'Ahorra tiempo en actualizaciones de carta.',
		multinacional_benefit_order_errors: 'Previene errores en los pedidos.',
		multinacional_benefit_tourist_experience: 'Mejora la experiencia de los turistas.',
		multinacional_benefit_staff_confidence: 'Da confianza a tu equipo.',
		multinacional_benefit_menu_decisions: 'Te ayuda a tomar decisiones sobre la carta.',
		multinacional_benefit_no_installation: 'No requiere instalación.',
		multinacional_howto_title: '¿Cómo funciona?',
		multinacional_step_upload: 'Subes tu carta a Reco.',
		multinacional_step_access: 'Tus clientes acceden vía QR.',
		multinacional_step_show: 'Reco muestra tus platos destacados y responde preguntas.',
		multinacional_step_control: 'Tú controlas qué destacar cada día.',
		multinacional_cta_title: 'Haz que tus clientes disfruten más.',
		multinacional_cta_description: 'Haz que tu equipo trabaje mejor.',
		multinacional_cta_demo: 'Solicita una demo para restaurantes multinacionales',
		multinacional_cta_cases: 'Ve cómo Reco ayuda a restaurantes como el tuyo',
	...
	'es-MX': {
		...
		blog_post_1423_title: '¿Cómo vender con tu menú sin mover un dedo?',
		blog_post_1423_excerpt: 'En la mayoría de los restaurantes, el menú solo hace una cosa: enumera los platillos. No sugiere. No ofrece más ventas. No ayuda a los comensales a decidir.',
		blog_post_1412_title: 'Los menús son los nuevos anfitriones: Por qué las primeras impresiones empiezan aquí',
		blog_post_1412_excerpt: 'Antes de la primera sonrisa del mesero, antes del pedido de bebidas, antes de que el agua llegue a la mesa, su comensal conoce el menú.',
		blog_post_1408_title: 'Los huéspedes no quieren datos. Quieren decisiones.',
		blog_post_1408_excerpt: 'Pedir comida a domicilio debería ser fácil. Pero la mayoría de los menús parecen hojas de cálculo. Listas interminables.',
		blog_post_1397_title: '¿Por qué los menús PDF te cuestan dinero?',
		blog_post_1397_excerpt: 'Si tu menú digital todavía está en formato PDF, no está ofreciendo una mejor experiencia. Estás ofreciendo una impresión en una pantalla.',
		blog_post_1411_title: 'Que hace Reco para los dueños de restaurantes',
		blog_post_1411_excerpt: 'Reco no es solo un menú digital. Es una herramienta que ayuda a los dueños de restaurantes a vender más y mejor.',
		blog_post_1421_title: 'De los antojos a las conversaciones: cómo el menú de Reco se creó para hablar',
		blog_post_1421_excerpt: 'El menú de Reco fue diseñado para entender lo que quieres y guiarte hacia la mejor decisión.',
		blog_post_1350_title: 'La importancia de la fidelización en la industria de hostelería',
		blog_post_1350_excerpt: 'La fidelización de clientes es clave para el éxito de cualquier restaurante. Descubre cómo lograrlo.',
		blog_post_1365_title: '¿Cómo optimizar la rotación de mesas en tu restaurante?',
		blog_post_1365_excerpt: 'La rotación de mesas es fundamental para maximizar los ingresos de tu restaurante.',
		...
		multinacional_hero_title_1: 'Consistencia global, experiencia local.',
		multinacional_hero_title_2: 'Reco se adapta a cada mercado.',
		multinacional_hero_subtitle: 'Reco es el mesero digital que apoya a tu equipo.',
		multinacional_info: 'Reco traduce, recomienda y promociona tu menú sin tener que imprimir nada ni capacitar a todo el personal.',
		multinacional_problem_title: 'El problema',
		multinacional_problem_desc_1: 'Operaciones en múltiples países, equipos rotativos, comensales de todo el mundo.',
		multinacional_problem_desc_2: 'Reco es la ayuda invisible que mantiene la experiencia consistente y local.',
		multinacional_solution_title: '¿Qué hace Reco?',
		multinacional_feature_translate: 'Traduce automáticamente tu menú.',
		multinacional_feature_highlight: 'Destaca los platillos que quieres impulsar.',
		multinacional_feature_answer: 'Responde las preguntas frecuentes de los comensales.',
		multinacional_feature_help_staff: 'Ayuda al personal nuevo a vender como un veterano.',
		multinacional_feature_analytics: 'Te muestra qué platillos funcionan mejor.',
		multinacional_benefits_title: 'Beneficios concretos',
		multinacional_benefit_menu_time: 'Ahorra tiempo en actualizaciones de menú.',
		multinacional_benefit_order_errors: 'Previene errores en las órdenes.',
		multinacional_benefit_tourist_experience: 'Mejora la experiencia de turistas.',
		multinacional_benefit_staff_confidence: 'Le da tranquilidad a tu equipo.',
		multinacional_benefit_menu_decisions: 'Te ayuda a tomar decisiones de menú.',
		multinacional_benefit_no_installation: 'No requiere instalación.',
		multinacional_howto_title: '¿Cómo funciona?',
		multinacional_step_upload: 'Subes tu menú a Reco.',
		multinacional_step_access: 'Tus comensales acceden vía QR.',
		multinacional_step_show: 'Reco muestra tus platillos destacados y responde preguntas.',
		multinacional_step_control: 'Tú controlas qué destacar cada día.',
		multinacional_cta_title: 'Deja que tus comensales disfruten más.',
		multinacional_cta_description: 'Deja que tu equipo trabaje mejor.',
		multinacional_cta_demo: 'Solicita una demo para restaurantes multinacionales',
		multinacional_cta_cases: 'Ve cómo Reco ayuda a restaurantes como el tuyo'
	}
} as const;
